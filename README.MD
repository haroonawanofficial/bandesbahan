...
## ⚙️ Build Instrumented JS Shells
...
Save as `/etc/systemd/system/bandesbahan.service`:
...
> **Note:** Run only in authorized test environments to avoid unintended crashes.  
> © 2025 Haroon Ahmad Awan / Omega‑X R&D Division.
